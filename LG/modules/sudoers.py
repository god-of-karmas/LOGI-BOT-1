...
from LG.utils import formatter
from LG.utils.dbfunctions import (
    add_gban_user,
    get_served_chats,
    is_gbanned_user,
    remove_gban_user,
)
from LG.utils.functions import extract_user, extract_user_and_reason, restart

__MODULE__ = "🧞‍♂️ Sᴜᴅᴏᴇʀꜱ"
__HELP__ = """
